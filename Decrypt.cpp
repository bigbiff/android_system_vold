...
//             int pid = std::stoi(de->d_name);

// 			char cmdpath[PATH_MAX];
// 			sprintf(cmdpath, "/proc/%d/cmdline", pid);

// 			FILE* file = fopen(cmdpath, "re");
	...
	std::string unwrapSyntheticPasswordBlob(const std::string& spblob_path, const std::string& handle_str, const userid_t user_id,
		...
		if (*synthetic_password_version == SYNTHETIC_PASSWORD_VERSION_V2
			...
			* https://android.googlesource.com/platform/frameworks/base/+/android-8.0.0_r23/keystore/java/android/security/keystore/AndroidKeyStoreAuthenticatedAESCipherSpi.java#216 */
			...
			printf("unwrapSyntheticPasswordBlob::1\n");
			if (!rc.isOk()) {
				return disk_decryption_secret_key;
			}		
			printf("unwrapSyntheticPasswordBlob::2\n");
			...
			printf("unwrapSyntheticPasswordBlob::3\n");
			if (!begin_rc.isOk()) {
				return disk_decryption_secret_key;
			} 		
			printf("unwrapSyntheticPasswordBlob::4\n");
			...
			printf("unwrapSyntheticPasswordBlob::5\n");
			...
			//     return disk_decryption_secret_key;
			// }
			printf("unwrapSyntheticPasswordBlob::6\n");
			...
			printf("unwrapSyntheticPasswordBlob::7\n");
			...
			*/
			...
			printf("unwrapSyntheticPasswordBlob::8\n");			
			if (!personalized_application_id) {
				return disk_decryption_secret_key;
			}
			printf("unwrapSyntheticPasswordBlob::9\n");
			...
			printf("unwrapSyntheticPasswordBlob::10\n");
			if (!secret_key) {
				printf("malloc failure on secret key\n");
				return disk_decryption_secret_key;
			}
			printf("unwrapSyntheticPasswordBlob::11\n");
			...
			printf("unwrapSyntheticPasswordBlob::12\n");
			...
			printf("unwrapSyntheticPasswordBlob::13\n");
